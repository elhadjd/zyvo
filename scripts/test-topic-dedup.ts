...
} from '../src/lib/ai/research-engine/topic-dedup';

const ERP_ARTICLE = {
  title: 'ERP PME Guinée : le guide complet pour choisir et réussir votre digitalisation',
  slug: 'erp-pme-guinee-le-guide-complet-pour-choisir-et-reussir-votre-digitalisation',
  excerpt: 'Choisir un ERP pour votre PME en Guinée',
  keywords: 'ERP Guinée, PME, digitalisation',
...
assert(
  topicSimilarity(
    'Impôt sur les sociétés en Guinée : guide complet pour les PME',
    ERP_ARTICLE.title
  ) < 0.42
);
...
assert(
  topicSimilarity(
    'Retenue à la source en Guinée : guide complet pour les entreprises',
    ERP_ARTICLE.title
  ) < 0.42
);
