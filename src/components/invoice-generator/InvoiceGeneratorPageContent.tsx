...
import type { InvoiceCountryConfig } from '@/data/invoice-generator/types';
import InvoiceGeneratorWidget from './InvoiceGeneratorWidget';

interface InvoiceGeneratorPageContentProps {
  config: InvoiceCountryConfig;
  basePath: string;
  hubLabel: string;
}

export default function InvoiceGeneratorPageContent({
  config,
  basePath,
  hubLabel,
}: InvoiceGeneratorPageContentProps) {
  ...
  return (
    <div className="space-y-10">
      ...
      <InvoiceGeneratorWidget config={config} />
