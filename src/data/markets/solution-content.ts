...
const CI_SOLUTION_CONTENT: Record<string, SolutionContent> = {
  'point-of-sale': {
    title: 'Caisse (POS) pour entreprises ivoiriennes',
    subtitle:
      'Encaissez rapidement en espèces, Orange Money, Orange Money ou Moov Money. Interface optimisée pour tablettes et connexions 4G à Abidjan.',
    benefits: [
      'Encaissement Orange Money et Orange Money',
      'Tickets et reçus personnalisés',
      'Suivi des ventes par caissier',
      'Mode dégradé hors connexion',
      'Compatible tablette Android',
  ...
  'inventory-management': {
    title: 'Gestion d\'inventaire',
    subtitle:
      'Suivez votre stock en temps réel, recevez des alertes de rupture et gérez les transferts entre vos points de vente à Abidjan, Yopougon et en province.',
    benefits: [
      'Stock en temps réel',
      'Alertes de rupture automatiques',
      'Transferts inter-magasins',
  ...
  'employee-management': {
    title: 'Gestion des employés',
    subtitle:
      'Horaires, rôles, commissions et permissions pour protéger vos données et motiver votre équipe en Côte d\'Ivoire.',
    benefits: [
      'Rôles et permissions',
      'Suivi des horaires',
      'Commissions sur ventes',
  ...
  'customer-queue-management': {
    title: 'File d\'attente & SMS',
    subtitle:
      'Réduisez l\'attente dans vos salons et services abidjanais avec des notifications SMS automatiques.',
    benefits: [
      'File d\'attente numérique',
      'Notifications SMS clients',
      'Affichage temps d\'attente',
  ...
  invoicing: {
    title: 'Facturation & devis',
    subtitle:
      'Générez des factures conformes NCC, suivez la TVA DGI et envoyez des devis professionnels à vos clients B2B.',
    benefits: [
      'Factures et devis en PDF',
      'Suivi TVA 18 %',
      'Relances de paiement',
  ...
  logistics: {
    title: 'Logistique & livraisons',
    subtitle:
      'Suivez vos expéditions, livraisons et flotte à Abidjan, Yopougon et en région. Optimisez les tournées et informez vos clients par SMS.',
    benefits: [
      'Suivi des livraisons en temps réel',
      'Gestion des tournées et chauffeurs',
      'Preuve de livraison photo',
      'Facturation transport intégrée',
      'Rapports par zone (Cocody, Plateau…)',
    ],
  },
  purchasing: {
    title: 'Achats & approvisionnement',
  ...
  scheduling: {
    title: 'Rendez-vous & planning',
    subtitle:
      'Gérez les rendez-vous de vos salons, cliniques et cabinets à Abidjan. Rappels SMS et agenda partagé.',
    benefits: [
      'Agenda en ligne pour clients',
      'Rappels SMS automatiques',
      'Planning par employé',
  ...
  'online-store': {
    title: 'Boutique en ligne',
    subtitle:
      'Lancez votre e-commerce en Côte d\'Ivoire avec catalogue produits, Orange Money/Orange Money et stock synchronisé avec votre magasin.',
    benefits: [
      'Catalogue produits en ligne',
      'Stock sync POS ↔ boutique',
      'Paiement Orange Money et Orange Money',
      'Commandes et livraisons Abidjan',
      'Pages optimisées mobile',
    ],
  },
  'marketing-analytics': {
...
export function getMarketSolutionContent(
  ...
  if (marketCode === 'ci') return CI_SOLUTION_CONTENT[slug];
