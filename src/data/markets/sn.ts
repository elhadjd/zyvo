...
export const snMarket: MarketConfig = {
  ...
  pages: {
    ...
    pricing: {
      title: 'Tarifs ZYVO Sénégal — Plans en FCFA dès 11 950 FCFA/mois',
      description:
        'Tarifs ZYVO en FCFA à partir de 11 950 FCFA/mois (annuel). Essai gratuit 7 jours pour les PME sénégalaises. Comparez Essentiel, Croissance et Entreprise.',
