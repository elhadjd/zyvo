...
export const ciMarket: MarketConfig = {
  ...
  pages: {
    ...
    pricing: {
      title: 'Tarifs ZYVO Côte d\'Ivoire — Plans en FCFA dès 23 900 FCFA/mois',
      description:
        'Tarifs ZYVO en FCFA à partir de 23 900 FCFA/mois (annuel). Essai gratuit 7 jours pour les PME ivoiriennes. Comparez Essentiel, Croissance et Entreprise.',
