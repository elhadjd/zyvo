...
export const gnMarket: MarketConfig = {
  ...
  pages: {
    ...
    pricing: {
      ...
      description:
        'Tarifs ZYVO en GNF à partir de 180 000 FG/mois (annuel). Essai gratuit 7 jours pour les PME guinéennes. Comparez Essentiel, Croissance et Entreprise.',
